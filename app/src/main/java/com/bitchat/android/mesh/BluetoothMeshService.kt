...
class BluetoothMeshService(private val context: Context) {
    ...
    // Expose application context for services that need it (e.g., AI)
    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            ...
            override fun onPeerRemoved(peerID: String) {
                delegate?.didUpdatePeerList(peerManager.getActivePeerIDs())
            }
        }
    ...
    fun sendBroadcastAnnounce() {
        ...
        serviceScope.launch {
            ...
            val encodedPayload = announcement.encode()
            if (encodedPayload == null) {
                Log.e(TAG, "Failed to encode announcement as TLV")
                return@launch
            }
            var tlvPayload: ByteArray = encodedPayload
     ...
     * @return true if the transfer was found and cancelled
     */
    fun cancelFileTransfer(transferId: String): Boolean {
        Log.d(TAG, "Cancelling file transfer: $transferId")
     ...
     * @param toPeerID The recipient peer ID
     * @param filePacket The file packet to send
     * @return true if the file was queued for sending
     */
    fun sendFilePrivate(toPeerID: String, filePacket: Any): Boolean {
        Log.d(TAG, "Sending file to peer: $toPeerID")
     ...
     * @param filePacket The file packet to broadcast
     * @return true if the file was queued for broadcast
     */
    fun sendFileBroadcast(filePacket: Any): Boolean {
        Log.d(TAG, "Broadcasting file to all peers")
